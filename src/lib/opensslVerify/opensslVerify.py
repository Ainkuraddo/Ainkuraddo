...
# Long message bug fixed by Ainkuraddo
...
def getMessagePubkey(message, sig):
    ...
    if type(pkey) is not int and not pkey.value:
        raise Exception(
            "OpenSSL %s (%s) EC_KEY_new_by_curve_name failed: %s, probably your OpenSSL lib does not support secp256k1 elliptic curve. Please check: https://github.com/Ainkuraddo/Ainkuraddo/issues/132" %
