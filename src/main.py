...
update_after_shutdown = False  # If set True then update and restart ainkuraddo after main loop ended
restart_after_shutdown = False  # If set True then restart ainkuraddo after main loop ended
...
if config.action == "main":
    ...
    try:
        ...
        print("Can't open lock file, your Ainkuraddo client is probably already running, exiting... (%s)" % err)
...
actions = Actions()
# Starts here when running ainkuraddo.py
