...
class TestConfig:
    def testParse(self):
        # Defaults
        config_test = Config.Config("ainkuraddo.py".split(" "))
        ...
        config_test = Config.Config("ainkuraddo.py --debug --debug_socket --ui_password hello".split(" "))
        config_test.parse(silent=True, parse_config=False)
        ...
        # More complex test
        args = "ainkuraddo.py --unknown_arg --debug --debug_socket --ui_restrict 127.0.0.1 1.2.3.4 "
