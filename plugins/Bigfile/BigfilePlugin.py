...
class UiRequestPlugin(object):
    def isCorsAllowed(self, path):
        if path == "/Ainkuraddo-Internal/BigfileUpload":
            return True
        else:
...
class UiWebsocketPlugin(object):
    def actionBigfileUploadInit(self, to, inner_path, size):
        ...
        return {
            "url": "/Ainkuraddo-Internal/BigfileUpload?upload_nonce=" + nonce,
            "piece_size": piece_size,
            "inner_path": inner_path,
...
class ContentManagerPlugin(object):
    ...
    def readFile(self, file_in, size, buff_size=1024 * 64):
        ...
        while 1:
            ...
            if part_num % 100 == 0:  # Avoid blocking Ainkuraddo execution during upload
                time.sleep(0.001)
