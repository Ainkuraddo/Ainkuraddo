    ...
    def actionCertAdd(self, *args, **kwargs):
        ...
        message = """
            ...
            <div style='text-align: center; font-size: 85%; margin-bottom: 10px;'>
             ...
             class='masterseed_download' download='ainkuraddo_private_key.backup'>Download backup as text file</a>
            </div>
            <div>
            ...
            <small>This site allows you to browse Ainkuraddo content, but if you want to secure your account <br>
            and help to keep the network alive, then please run your own <a href='https://ainkuraddo.io' target='_blank'>Ainkuraddo client</a>.</small>
        """
        ...
        script = """
            ...
            $("#button_notification_download").on("mousedown", function() {
                this.href = window.URL.createObjectURL(new Blob(["Ainkuraddo user master seed:\\r\\n{master_seed}"]))
            })
