...
class UiWebsocketPlugin(object):
    def sidebarRenderPeerStats(self, body, site):
        ...
        copy_link = "http://127.0.0.1:43110/%s/?ainkuraddo_peers=%s" % (
        ...
        body.append(_(u"""
            <li>
             <label>
              ...
              <a href='/Ainkuraddo-Internal/Zip?address={site.address}' id='link-zip' class='link-right' download='site.zip'>{_[Save as .zip]}</a></small>
             </label>
             <ul class='graph graph-stacked'>
        """))
