...
class TestOptionalManager:
    ...
    def testVerifyFiles(self, site):
        ...
        # Write file from outside of Ainkuraddo
        ...
        # Delete file outside of Ainkuraddo
    ...
    def testVerifyFilesSameHashId(self, site):
        ...
        # Write files from outside of Ainkuraddo (For quick check hash does not matter only file size)
